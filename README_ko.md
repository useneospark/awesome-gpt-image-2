...
**GPT Image 2**는 OpenAI의 최신 이미지 생성 모델로, ChatGPT의 네이티브 이미지 생성 기능을 제공합니다.

- **사진급 실제감** — 정확한 해부학, 조명, 텍스처
- **완벽한 텍스트 렌더링** — 인용문, 표지판, UI 라벨이 선명하고 읽기 쉬움
- **스타일 일관성** — 대화 내 여러 이미지에서 통일된 스타일
- **고급 편집** — 자연어로 기존 이미지 수정
- **멀티모달 이해** — 이전 메시지의 맥락 이해

> ChatGPT Plus 없이 GPT Image 2를 사용하고 싶으신가요? [NeoSpark는 모든 플랜에 GPT Image 2를 포함합니다](https://useneospark.com/pricing?ref=awesome-gpt-image-2) — 추가 비용 없이, 즉시 접속.
...
자세한 프롬프트는 [영어 README](README.md#cinematic--film)를 참조하세요.
...
자세한 프롬프트는 [영어 README](README.md#portraits--beauty)를 참조하세요.
